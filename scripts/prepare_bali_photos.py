...
SHOTS = {
    ...
    "cover":     dict(src="vita-bowl.jpg", ratio=(4, 5), w=853, wm=700, focus=(0.45, 0.42), grade="glow"),

    # Разворот сразу за обложкой: вилла над долиной Убуда в утреннем тумане
    "spread":    dict(src="ubud-fog.jpg", ratio=(2, 1), w=1280, wm=900, focus=(0.50, 0.55), grade="hotel"),

    # Манифест и практики
    "manifesto":        dict(src="hands-palosanto.jpg", ratio=(4, 5), w=900, wm=640, focus=(0.50, 0.56), grade="team"),
    "practice-morning": dict(src="ilya-taiji.jpg",      ratio=(4, 5), w=900, wm=640, focus=(0.50, 0.52), grade="glow"),
...
PROFILES = {
    ...
    "glow": dict(warm_r=1.03, warm_b=0.975, green=0.95, sat=1.02, contrast=1.04, sharpen=40, bright=1.06),
    # Честное ч/б без тонирования
    "bw": dict(warm_r=1.0, warm_b=1.0, green=1.0, sat=0.0, contrast=1.08, sharpen=40),
